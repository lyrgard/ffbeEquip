...
class DataStorage {
    ...
    addDesirableElementsFromImperilInFormula(formula) {
        ...
        } else if (formula.type != "elementCondition" &&  formula.type != "constant" && formula.type != "break" && formula.type != "imbue" && formula.type != "statsBuff" && formula.type != "value" && formula.type != "damage" && formula.type != "killers" && formula.type != "skillEnhancement") {
