    ...
    static getComparison(treeNode1, treeNode2, stats, ennemyStats, desirableElements, desirableItemIds, includeSingleWielding, includeDualWielding) {
        ...
        for (var index = stats.length; index--;) {
            if (stats[index] == "physicalKiller") {
                ...
                comparisionStatus.push(TreeComparator.compareByValue(treeNode1.equivalents[0].item, treeNode2.equivalents[0].item, "lbDamage"));
            } else {
                comparisionStatus.push(TreeComparator.compareByValue(treeNode1.equivalents[0].item, treeNode2.equivalents[0].item, stats[index]));
                ...
                if (baseStats.includes(stats[index])) {
                    comparisionStatus.push(TreeComparator.compareByValue(treeNode1.equivalents[0].item, treeNode2.equivalents[0].item, "esperStatsBonus." + stats[index]));
                }
