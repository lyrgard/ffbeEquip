...
class UnitBuild {
    ...
    setLevel(level) {
        ...
        if (this.unit) {
            if (this._level > 100) {
                this.stats = {
                    "hp": this.unit.stats.minStats.hp + Math.round((this.unit.stats.maxStats.hp - this.unit.stats.minStats.hp) * statProgression[this._level - 101] / 100),
                    "mp": this.unit.stats.minStats.mp + Math.round((this.unit.stats.maxStats.mp - this.unit.stats.minStats.mp) * statProgression[this._level - 101] / 100),
                    "atk": this.unit.stats.minStats.atk + Math.round((this.unit.stats.maxStats.atk - this.unit.stats.minStats.atk) * statProgression[this._level - 101] / 100),
                    "def": this.unit.stats.minStats.def + Math.round((this.unit.stats.maxStats.def - this.unit.stats.minStats.def) * statProgression[this._level - 101] / 100),
                    "mag": this.unit.stats.minStats.mag + Math.round((this.unit.stats.maxStats.mag - this.unit.stats.minStats.mag) * statProgression[this._level - 101] / 100),
                    "spr": this.unit.stats.minStats.spr + Math.round((this.unit.stats.maxStats.spr - this.unit.stats.minStats.spr) * statProgression[this._level - 101] / 100),
                };
            } else {
                this.stats = this.unit.stats.maxStats;
            }
